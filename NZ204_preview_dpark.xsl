...
<?xml-stylesheet type="text/xsl" href="file:///C:/DB/Light/Light%20List/NZ204_preview_dp.xsl"?>
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs xsi" version="2.0">
		...
		<html>
			<head>
				...
				<style type="text/css">
                    ...
                    .logo-edition-date{
                    background-image: url('LINZ-logo.jpg');
	...
	<xsl:template match="NM_NZ204_LOL_PUBLICATION">
		<div align="right" width="100px" height="100px">
		<!-- img link -->    
		<!--<img src="HN_HeaderV1.jpg" alt="LOGO_IMAGE" />-->
			<img src="N:\HPD\shared\HPD40\PM_LINZConfiguration\Light List\LINZ-logo.jpg" width="300" alt="LOGO_IMAGE"/>
		</div>
		...
		<p style="font-weight:bold;text-align:center;font-size:32pt;margin-top:100px;">
			<xsl:value-of select="SECTION_LIST/SECTION_LIST_ITEM/NM_NZ204_LIGHTLIST_GROUP/NZ_204_REGION"/>
		</p>
		<p style=" text-align:center;margin-bottom:275px;font-size:14pt;">(updated to NTM Edition <xsl:value-of select="EDITION"/>, 
            <xsl:call-template name="publishdateformat">
				<xsl:with-param name="datestr" select="$publish_date"/>
			</xsl:call-template>)</p>
				...
				<table width="100%" style="font:'Helvetica Neue', Helvetica !important;font-size:9pt; padding:0px; margin:0px; border-collapse:collapse;">
					<tbody class="abbreviations_inlights">
						...
						<tr>
							<td> </td>
							<td>
								<span>greenish-white</span> in colour</td>
							<td>WNW....................</td>
						...
						<tr>
							...
							<td>Y...........................</td>
							<td>
								<span>Yellow</span>, <span>amber</span> or <span>orange</span>
							</td>
						</tr>
					</tbody>
				</table>
		...
		<div style="margin-top:10px;">
			...
			<div style="margin-bottom: 10px ; ">
				<table style="font-size:9pt; margin:0px; padding:0px;" class="layout_common_headings">
					...
					<tr>
						...
						<td>Location, name.<br/>Place is printed in CAPITALS.<br/>The names of lights having a range of 15 miles and over are printed in bold type.</td>
					</tr>
					<tr>
						<td valign="top">Column 3:</td>
						<td>Latitude and longitude are given to two decimal places of a minute where data accuracy permits.</td>
					</tr>
				</table>
			</div>
			<table style="margin-top:6px;margin-bottom:6px;background-color:silver;border-top:1px solid black;border-bottom:1px solid black;">
				<tr>
					<td>
						<p style="text-align:justify;font-size:8.5pt;font-weight:bold;margin:5px;">IMPORTANT NOTE:</p>
						<p style="font-size:8.5pt;margin:0;">
							<span style="font-family:'Helvetica Neue', Helvetica !important;">
								<i>“Positions given are approximate. They are included only to help in the identification of features on charts. It is possible to
                                ...
                                as a result of the variations between geodetic reference systems”</i>
							</span>(refer page A-8, section 4.3, para. 4, M12 Standardization 
				...
				<thead>
					...
					<div style=" border-top: 1px solid #696969;">
						...
						<tr style="width:100%; background-color:silver; ">
							<th colspan="8">
								<h1>
									<xsl:value-of select="../NZ_204_REGION"/>
								</h1>
							</th>
						</tr>
					</div>
					<tr style="height:25px; text-align:center; background:silver;">
						<td style="width:10%;vertical-align:text-top; font-size:7pt !important;">
						...
						<td style="width:15%;vertical-align:text-top; font-size:7pt !important;">
							<table style="border-collapse:collapse; padding: 0px; margin:0px; font-size:7pt">
								<tr>
									<td>Location - Name</td>
								</tr>
						...
						<td style="width:12.4%;vertical-align:text-top; font-size:7pt !important;">
							<table style="border-collapse:collapse; padding: 0px; margin:0px; font-size:7pt">
								<tr>
									<td>Characteristics</td>
								</tr>
						...
						<td style="width:7%;vertical-align:text-top; font-size:7pt !important;">
							<table style="text-align:center; border-collapse:collapse; padding: 0px; margin:0px; font-size:7pt">
								<tr>
									<td>Elevation Metres</td>
								</tr>
							</table>
						</td>
						<td style="width:6%;vertical-align:text-top; font-size:7pt !important;">
							<table style="text-align:center; border-collapse:collapse; padding: 0px; margin:0px; font-size:7pt">
								<tr>
									<td>Range miles</td>
								</tr>
						...
						<td style="width:19%;vertical-align:text-top; font-size:7pt !important;">
							<table style="text-align:center; border-collapse:collapse; padding: 0px; margin:0px; font-size:7pt;">
								<tr>
									<td>Structure <br/> Height in metres</td>
								</tr>
							</table>
						</td>
						<td style="width:22%;vertical-align:text-top; font-size:7pt !important;">
							<table style="border-collapse:collapse; padding: 0px; margin:0px; font-size:7pt">
								<tr>
									<td>Remarks</td>
								</tr>
	...
	<xsl:template match="NM_LIGHT_LIST_RECORD">
       ...
       <tr>
		...
		<xsl:if test="INTERNATIONAL_NUMBER=3690.4">
			<tr>
				<td style="border-bottom:1px solid #696969;width:10%;vertical-align:text-top;"/>
				<td colspan="7" style="border-bottom:1px solid #696969;width:10%;vertical-align:text-top;"/>
			</tr>
			<tr bgcolor="#efeff5">
				<td style="border-bottom:1px solid #696969;width:10%;vertical-align:text-top;"/>
		...
		<xsl:choose>
			<xsl:when test="not(contains(INTERNATIONAL_NUMBER,'_'))">
				<tr>
					<td style="border-top:1px solid silver;width:6%;vertical-align:text-top;">
						<b>
							<xsl:value-of select="INTERNATIONAL_NUMBER"/>
						</b>
					</td>
					...
					<td style="border-top:1px solid silver;width:7%;vertical-align:text-top;text-align:right;padding-right:5px;">
						<xsl:value-of select="POSITION/LATITUDE"/>
						<br/>
						<xsl:value-of select="POSITION/LONGITUDE"/>
					</td>
					<td style="border-top:1px solid silver;width:8%;vertical-align:text-top;padding-left:2px;">
						<xsl:copy-of select="LIGHT_CHARACTERISTICS_ENG/node()"/>
					</td>
					<td style="border-top:1px solid silver;width:5%;vertical-align:text-top;text-align:center;">
						<xsl:copy-of select="LIGHT_HEIGHT/node()"/>
					</td>
					<td style="border-top:1px solid silver;width:5%;vertical-align:text-top;text-align:center;">
						<!--<xsl:choose>
                        <xsl:when test="number($gValue) &gt;= 15">
					...
					<td style="border-top:1px solid silver;width:20%;vertical-align:text-top;margin-left: 5px;">
						<!--<p style="margin-left: 15px"><xsl:copy-of select="NM_REMARKS"/></p>-->
						<xsl:copy-of select="NM_REMARKS"/>
						<!--<xsl:value-of select="count(i)"/>-->
						<!--<p style="margin-left: 15px"><xsl:copy-of select="OBSERVATION_ENG"></xsl:copy-of></p>-->
						<xsl:copy-of select="OBSERVATION_ENG"/>
						<xsl:choose>
						...
						<xsl:if test="NM_LIGHTS_STATUS != ''">
							<strong>
								<xsl:value-of select="../../../NM_YEAR_PUB"/>
							</strong>
						</xsl:if>
					</td>
				</tr>
			...
			<xsl:otherwise>
				<tr>
					<td style="width:6%;vertical-align:text-top;">
						<b>
							<xsl:if test="not(contains(INTERNATIONAL_NUMBER,'_'))">
								<xsl:value-of select="INTERNATIONAL_NUMBER"/>
							</xsl:if>
						</b>
					</td>
					...
					<td style="width:7%;vertical-align:text-top;text-align:right;padding-right:5px;">
						<xsl:value-of select="POSITION/LATITUDE"/>
						<br/>
						<xsl:value-of select="POSITION/LONGITUDE"/>
					</td>
					<td style="width:8%;vertical-align:text-top;padding-left:2px;">
						<xsl:copy-of select="LIGHT_CHARACTERISTICS_ENG/node()"/>
					</td>
					...
					<td style="width:20%;vertical-align:text-top;margin-left: 5px;">
						<!--<p style="margin-left: 15px"><xsl:copy-of select="NM_REMARKS"/></p>-->
						<xsl:copy-of select="NM_REMARKS/i"/>
						<!--<p style="margin-left: 15px"><xsl:copy-of select="OBSERVATION_ENG"></xsl:copy-of></p>-->
						<xsl:copy-of select="OBSERVATION_ENG"/>
						<xsl:choose>
							<xsl:when test="NM_LIGHTS_STATUS='Temporary'">
