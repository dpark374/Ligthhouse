        ...
        <div style= "margin-top:10px;">
            ...
            <div style= "margin-bottom: 10px ; ">
                ...
                <tr>
                    ...
                    <td >Location, name.<br></br>Place is printed in CAPITALS.<br></br>The names of lights having a range of 15 miles and over are printed in bold type.</td>
                </tr>
                <tr>
...
<tr bgcolor="#efeff5">
    ...
    <td colspan="7" style="border-bottom:1px solid #696969;width:10%;vertical-align:text-top;">WESTPORT AND BULLER RIVER</td>
        ...
        <tr>
            ...
            <td style="border-top:1px solid silver;width:10%;vertical-align:text-top;">
                    <xsl:copy-of select="DESC_STRUCT_HEIGHT_ENG/node()"/>
            ...
            <xsl:otherwise>
                <tr>
                    ...
                    <td style="width:10%;vertical-align:text-top; padding-right:5px;">
                        ...
                        <xsl:variable name="height" select="STRUCT_HEIGHT"/>
                        <p style="text-align:center;margin-top: 0px;margin-bottom: 2px;"><xsl:value-of select="$height"/></p>
